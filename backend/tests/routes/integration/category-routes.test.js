...
describe("Category Routes", () => {
    ...
    describe("GET /api/v1/categories", () => {
        ...
        it("should handle server errors", async () => {
            ...
            ); // Mock the getCategories function to throw an error
    ...
    describe("POST /api/v1/categories", () => {
        it("should create a new category", async () => {
            ...
            const response = await request(app)
                ...
                .send(newCategory); // Make a POST request to the endpoint with the new category data
        ...
        it("should handle server errors", async () => {
            queries.createCategory.mockRejectedValue(
                new Error("Database error")
            ); // Mock the createCategory function to throw an error

            const response = await request(app)
                .post("/api/v1/categories")
                .send({ name: "Clothing" }); // Make a POST request to the endpoint with some data
